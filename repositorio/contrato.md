...
docs/                               contrato.md · entradas.md · conferencia.md · duas-pernas.md
...
**Os outros arquivos do `docs/`:** `entradas.md` detalha o que o produtor entrega
e as bases que o sistema cruza, com formato, cadência e armadilhas.
`conferencia.md` é o checklist do que tem que sair, com a coluna "reprova se".
Nenhum dos dois compete com este: eles detalham, não decidem.

**Precedência:** em caso de conflito, **este arquivo ganha** sobre todos.
O `duas-pernas.md` está desatualizado nas regras e na cobertura por categoria —
use-o só para o enquadramento conceitual das duas provas.
