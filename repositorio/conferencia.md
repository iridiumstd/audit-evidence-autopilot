...
> Este arquivo não compete com o `contrato.md`: o contrato diz **o que construir**, esta lista diz **como conferir que ficou pronto**. Em caso de conflito, o contrato ganha.

---

## 01 · Os cinco outputs — não é só o dossiê
...
|---|---|---|---|
| **1 · Ficha do produtor** | Viva, permanente; muda quando chega documento | Tela | Prova que a ingestão funcionou: entrou pasta bagunçada, saiu ficha organizada |
| **2 · Dossiê do lote** | Congelada; recorte de um instante, versionada | PDF **e** HTML em `saida/dossies/` | É o produto. É o que aparece na tela no fim |
| **3 · Fila de exceções** | Viva, ordenada por severidade | Tela | Prova que o sistema decide o que merece atenção humana — e que não decide sozinho |
...
**O output que quase sempre é esquecido é o 5.** Vale abrir a pasta ao vivo na demo, lado a lado com a pasta de entrada. `foto_2843.jpg` virando `CAR-DEM_70123456789_20260514_v01.pdf` é a coisa mais fácil de entender do produto inteiro, e não custa nenhum slide.

---

## 02 · Ficha do produtor
...
| ☐ | **Lacunas** | Separadas por tipo: `lacuna_sanavel`, `dispensa_documentada`, `nao_sanavel_pelo_produtor` | Contar dispensa de licença ambiental como lacuna |
...
Leia qualquer texto da ficha em voz alta. Se em algum lugar estiver escrito *"Antônio está irregular"* em vez de *"falta o CCIR de Antônio"*, a tela reprova mesmo com o dado certo.

**O estado é do documento, nunca da pessoa** — é isso que impede o produto de transformar a Cláudia em fiscal dos cooperados.

---

## 03 · Dossiê do lote — as oito seções
...
### Se perguntarem por que dossiê por lote

Porque é o que a cadeia usa: a DDS é emitida por lote e enviada ao cliente na entrega. E nenhuma plataforma gratuita produz esse artefato — o Parque Cafeeiro emite declaração **por imóvel**, com validade de 180 dias.

> **Lote é a unidade do comércio; imóvel é a unidade do cadastro.**

---

## 04 · Fila de exceções e trilha de eventos

### Fila de exceções — a tela da manhã
...
| ☐ | Ordenada por severidade: **bloqueio (B) antes de flag (F)** | Ordenar por data ou alfabeticamente |
...
### Trilha de eventos — a prova de autonomia
...
## 05 · Os seis testes de conferência

Rodem antes do ensaio. Cada um leva menos de dois minutos e pega uma classe inteira de erro.
...
3. ☐ **Ache uma categoria fechada por checagem, não por documento.** Direitos humanos ou consulta às comunidades. Se as duas aparecerem como lacuna permanente, o conjunto mínimo não foi implementado — e essas categorias não vão fechar nunca.
...
Peguem **um produtor que tenha só posse, sem matrícula e sem licença ambiental** — que é o caso da maioria da base real.

Se o sistema aprovar esse produtor, com a prova de cada uma das oito categorias e a data de cada consulta, **o MVP está de pé**.

Se reprovar, a gente construiu a barreira que diz estar removendo — e aí não importa o resto.
